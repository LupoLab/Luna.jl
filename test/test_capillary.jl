...
@testset "dispersion" begin
    ...
    m = Capillary.MarcatilliMode(50e-6, :Ar, 2.0, model=:reduced, T=294.0)
    ω = wlfreq(800e-9)
    ...
    @test isapprox(Capillary.dispersion(m, 3, ω), 8.44025458282146e-44, rtol=7e-7)
    ...
    @test isapprox(Capillary.dispersion(m, 2, ω), -1.68088637707608e-29, rtol=1e-7)
    ...
    @test isapprox(Capillary.dispersion(m, 3, ω), 8.80530032930868e-44, rtol=5e-7)
