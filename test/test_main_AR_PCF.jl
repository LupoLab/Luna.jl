import Luna
import Luna: Grid, Maths, AR_PCF, PhysData, Nonlinear, Ionisation, NonlinearRHS, Output, Stats, LinearOps
import Logging
import FFTW
...
in1 = (func=gausspulse, energy=4.3e-6)
inputs = (in1, )
